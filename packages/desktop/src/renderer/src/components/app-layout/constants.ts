...
/** Sum of non-resizable widths: edge spacing（无 ActivityBar） */
export const APP_LAYOUT_FIXED_WIDTH = APP_LAYOUT_EDGE_SPACING;
...
export const PANEL_ORDER: PanelId[] = ["primarySidebar", "chatPanel", "contentPanel"];
...
export const APP_LAYOUT_GRID_AREA: Record<PanelId | SeparatorId | "titleBar", string> = {
...
/** CSS Grid template for the root layout. 3 列 5 轨（规范 §3.1）。 */
export const APP_LAYOUT_GRID = {
  gridTemplateAreas: `
    "${APP_LAYOUT_GRID_AREA.primarySidebar} ${APP_LAYOUT_GRID_AREA["primarySidebar:chatPanel"]} ${APP_LAYOUT_GRID_AREA.titleBar}   ${APP_LAYOUT_GRID_AREA.titleBar}               ${APP_LAYOUT_GRID_AREA.titleBar}"
    "${APP_LAYOUT_GRID_AREA.primarySidebar} ${APP_LAYOUT_GRID_AREA["primarySidebar:chatPanel"]} ${APP_LAYOUT_GRID_AREA.chatPanel}  ${APP_LAYOUT_GRID_AREA["chatPanel:contentPanel"]} ${APP_LAYOUT_GRID_AREA.contentPanel}"
  `,
