...
export const MessageContent = ({ children, className, ...props }: MessageContentProps) => (
  <div
    className={cn(
      ...
      "group-[.is-user]:ml-auto group-[.is-user]:overflow-hidden group-[.is-user]:rounded-xl group-[.is-user]:rounded-tr-md group-[.is-user]:bg-primary/8 dark:group-[.is-user]:bg-primary/15 group-[.is-user]:px-3.5 group-[.is-user]:py-2 group-[.is-user]:text-foreground",
      "group-[.is-assistant]:w-full group-[.is-assistant]:overflow-x-clip group-[.is-assistant]:text-foreground",
      className,
    )}
    {...props}
  >
