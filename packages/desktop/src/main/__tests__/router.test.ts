...
describe("main router context wiring", () => {
  it("ping returns pong", async () => {
    const context = {
      ...
      worktreeService: {} as unknown as AppDependencies["worktreeService"],
      llmService: {} as unknown as AppDependencies["llmService"],
      fsService: {} as unknown as AppDependencies["fsService"],
      notificationService: {} as unknown as AppDependencies["notificationService"],
      tokenReporter: {} as unknown as AppDependencies["tokenReporter"],
