          ...
          return (
            ...
            >
              <Toast.Close
                ...
                className="absolute -top-2 -left-2 z-10 inline-flex size-5 cursor-pointer items-center justify-center rounded-full border bg-popover not-dark:bg-clip-padding text-muted-foreground opacity-0 shadow-sm transition-opacity duration-200 before:pointer-events-none before:absolute before:inset-0 before:rounded-full before:shadow-[0_1px_--theme(--color-black/4%)] group-hover:opacity-100 hover:text-foreground focus-visible:opacity-100 focus-visible:outline-none dark:before:shadow-[0_-1px_--theme(--color-white/6%)]"
              >
              ...
              <Toast.Content className="pointer-events-auto flex items-center justify-between gap-1.5 overflow-hidden px-3.5 py-3 text-sm transition-opacity duration-250 data-behind:not-data-expanded:pointer-events-none data-behind:opacity-0 data-expanded:opacity-100">
                <div className="flex min-w-0 gap-2">
                  ...
                  <div className="flex min-w-0 flex-col gap-0.5">
                    <Toast.Title className="break-words font-medium" data-slot="toast-title" />
                    <Toast.Description
